...
class Dashboard extends Component {
  ...
  updatemetricsgraphs() {
    ...
    for(var metric of this.state.selected_metrics)
    {
      ...
      let url = 'https://stockstats.mq2psnamep.us-east-1.elasticbeanstalk.com/financialy-metrics?stocks=' + stock + ';&metrics=' + metric + ';&frequency=ANNUAL';
...
handleStockAddition = (event,value) => { // add stock color same as sync graph
  const axios = require('axios');
    ...
    var url = 'https://stockstats.mq2psnamep.us-east-1.elasticbeanstalk.com/get/daily_price/' + ticker + '/d/d';
